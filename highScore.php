...
$game = [
    ...
    ["name" => "Guessing Number", "image" => "guess.jpg", "link" => "http://localhost/projet-jeux/jeuNumber.php", "record" => $_SESSION['record_guess']],
    ["name" => "Flappy Bird", "image" => "flappy.jpg", "link" => "http://localhost/projet-jeux/FlappyBird", "record" => $_SESSION['record_flappy']],
];
