  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div style=" padding-bottom: 3vh" class="col-12">
        <a href="https://games-online.herokuapp.com/DiceGame/jeu.php"><img class="une" src="photoDé.jpg" alt="#1 Tendance"></a>
    ...
    <div class="row" style="height : 30vh">
      ...
      <div  class="col-12 col-md-6 "  >
        ...
        <a href="https://games-online.herokuapp.com/jeuNumber.php"><img class="pfc " id="third-box" src="guess.jpg" alt="#1 Tendance"></a>
      </div>
      <div class="col-12 col-md-6" id='container-second-box'>
          <a href="https://games-online.herokuapp.com/QuizCap/capital.php"><img class="pfc" id='second-box' src="jeuxCap.jpg" alt="#1 Tendance"></a>
      </div>
