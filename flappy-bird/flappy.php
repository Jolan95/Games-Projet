...
<html lang="en">
    ...
    <body>
        ...
        input  = document.getElementById("record");
        let record = parseInt(input.value);
            ...
            update: function(){
                ...
                for(let i = 0; i < this.position.length; i++){
                    ...
                    if(p.x + this.w <= 0){
                        ...
                        score.value += 1;
                        SCORE_S.play();
                        if (score.value > record){
                            record = score.value;
                                $.ajax({
                                    url : 'recordFlappy.php',
                                    type : 'POST',
                                    data:{
                                        new_record: score.value,
                                      },
        ...
        const score= {
            ...
            draw : function(){
                ...
                if(state.current == state.game){
                    ...
                    // BEST SCORE
                    ctx.fillText(record || 0, 225, 228);
                    ctx.strokeText(record || 0, 225, 228);
                }
            },
