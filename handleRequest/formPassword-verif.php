    ...
    if($statement->execute()) {
        ...
        if($users !== false ) {
            ...
            if($statement2->execute()){
                $sendTo = $mail;
                $content = "<div style='margin : 10%'>Cliquez sur le lien ci dessous afin de réinitaliser votre mot de passe : <p><a href='https://games-online.herokuapp.com/resetPassword.php/?token=".$bytes."'>Réinitialiser mon mot de passe</a>.</p>";
                $email = new Mail();
